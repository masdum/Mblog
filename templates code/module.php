                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="<?php echo BLOG_URL; ?>?post=5">
                                    工具箱
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo BLOG_URL; ?>?post=4">
                                    关于我
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo BLOG_URL; ?>?post=6">
                                    作品集
                                </a>
                            </li>
                            <li>
                                <a target="_blank" href="http://i.youku.com/i/UMzAyNDk0NDQ0/videos?spm=a2hzp.8244740.0.0">
                                    优酷频道
                                </a>
                            </li>
                            <li>
<a target="_blank" href="https://github.com/masdum/">
                                    Github
                                </a>                            </li>
                        </ul>
                    </div>
